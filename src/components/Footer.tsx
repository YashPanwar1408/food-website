...
const Footer = () => {
  ...
  return (
    <footer className="bg-card text-card-foreground border-t border-border" aria-label="Footer">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <nav aria-labelledby="quick-links-heading">
              <h3 id="quick-links-heading" className="text-lg font-semibold text-foreground">Quick Links</h3>
          ...
          <div className="space-y-4">
            <nav aria-labelledby="categories-heading">
              <h3 id="categories-heading" className="text-lg font-semibold text-foreground">{t('categories')}</h3>
              <ul className="space-y-2">
